# -*- coding: utf-8 -*-
"""
Created on Sat Mar 23 18:48:37 2024
...
class Problem61(Problem):
    ...
    def solve(self, **kwargs):
        ...
        max_int = 10_000
        min_int = 1_000
        coefficients_min = [[1/2,1/2,-min_int],[1/2,0,-min_int],[3/2,-1/2,-min_int],[2,-1,-min_int],[5/2,-3/2,-min_int],[3,-2,-min_int]]
        coefficients_max = [[1/2,1/2,-max_int],[1/2,0,-max_int],[3/2,-1/2,-max_int],[2,-1,-max_int],[5/2,-3/2,-max_int],[3,-2,-max_int]]
        ...
        L = [triangles_dict,squares_dict,pentagonals_dict,hexagonals_dict,heptagonals_dict,octagonals_dict]
                                        ...
                                        if s5 in permutation[3]['end'].keys():
                                            for number4 in permutation[3]['end'][s5]:
                                                ...
                                                if s4 in permutation[2]['end'].keys():
                                                    for number3 in permutation[2]['end'][s4]:
                                                        s3 = number3[:2]
                                                        if s3 in permutation[1]['end'].keys():
                                                            for number2 in permutation[1]['end'][s3]:
                                                                s2 = number2[:2]
                                                                if s2 == e1:
                                                                    return sum([int(number1),int(number2),int(number3),int(number4),int(number5),int(number6)]), [int(number1),int(number2),int(number3),int(number4),int(number5),int(number6)]
